...
# 控制参数
speed = 100.0  # 电机速度
forward_duration = 5.0  # 前进持续时间（秒）
turn_duration = 1.0  # 转弯持续时间（秒）
...
def move_forward():
    ...
    print(f"前进: 电机1={speed}, 电机2={speed}, 电机3={speed}")
...
def move_backward():
    ...
    data.ctrl[drive_motor_2] = -speed
    data.ctrl[drive_motor_3] = -speed
    print(f"后退: 电机1={-speed}, 电机2={-speed}, 电机3={-speed}")
...
def turn_left():
    ...
    data.ctrl[drive_motor_2] = -speed
    data.ctrl[drive_motor_3] = -speed
    print(f"左转: 电机1={speed}, 电机2={-speed}, 电机3={-speed}")
...
def turn_right():
    ...
    data.ctrl[drive_motor_2] = speed
    data.ctrl[drive_motor_3] = speed
    print(f"右转: 电机1={-speed}, 电机2={speed}, 电机3={speed}")
